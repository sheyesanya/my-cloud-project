      ...
      <div style={{ flex:1, display:'flex', alignItems:'flex-start', justifyContent:'center', padding:'40px 20px' }}>
        <div style={{ width:'100%', maxWidth:560 }}>
          ...
          <div style={{ marginBottom:28, position:'relative' }}>
            <div style={{ fontFamily:'Manrope,sans-serif', fontWeight:900, fontSize:72, color:'rgba(212,168,67,0.05)', position:'absolute', top:-14, left:-6, lineHeight:1, userSelect:'none', pointerEvents:'none', letterSpacing:'-3px' }}>
